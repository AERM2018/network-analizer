...
def main():
  ...
  target_netcommnads_funcs = [net_exec.ping_ip,net_exec.arp,net_exec.lsof,net_exec.route]
  ...
  target_vulnerability_funcs = [vul_exec.exec_port_scanner,vul_exec.exec_sniffer,vul_exec.exec_sqli,vul_exec.exec_wifi_scanner,vul_exec.exec_ddos_attack]
...
# Run criptography funcs
  target_criptography_funcs = [[crip_exec.exec_cipher,'HOLA MUNDO'],[crip_exec.generate_key,None],[crip_exec.generate_md5,'Example'],[crip_exec.generate_signature,net_exec.get_host_name()]]
  ...
  print(colorama.Fore.LIGHTMAGENTA_EX+'Time taken: {:.4f} sec(s).\n'.format(timef-timei))
  print(colorama.Fore.WHITE+'----------------------------\n')
